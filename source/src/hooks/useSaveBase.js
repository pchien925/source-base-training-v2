...
const message = defineMessages({
    ...
    create: 'Thêm mới',
    update: 'Cập nhật',
    title: '{action, select, true {Sửa} other {Tạo}} {objectName}',
});
...
const useSaveBase = ({
    ...
    const getActionName = () => {
        return isEditing ? intl.formatMessage(message.update) : intl.formatMessage(message.create);
    };
